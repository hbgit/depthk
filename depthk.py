...
class DepthK(object):
    def __init__(self, _cfilepath):
        ...
        self.pipscommand = os.path.abspath(".") + "/modules/PIPS/tpips"
    ...
    def callesbmccheck(self, _cfilepath, _enableforceassume, _enablelastcheckbasecase):
        ...
        runesbmc.useUltimateAutomizer = self.useUltimateAutomizer
...
if __name__ == "__main__":
    ...
    parser.add_argument('-u', '--ua', action="store_true", dest='setUltimateAutomizer', help='Ultimate Automizer as Witness validator. The default is CPAchecker', default=False)
    ...
    if args.inputCProgram:
        if not os.path.isfile(args.inputCProgram):
            ...
            if args.setUltimateAutomizer:
               rundepthk.useUltimateAutomizer = True
