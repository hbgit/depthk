# 1 "SNU_fir_nondet_true-unreach-call.c"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "SNU_fir_nondet_true-unreach-call.c"
# 55 "SNU_fir_nondet_true-unreach-call.c"
float fir_filter(float input,float *coef,int n,float *history);

static float gaussian(void);
# 67 "SNU_fir_nondet_true-unreach-call.c"
  float fir_lpf35[35] = {
...
# 110 "SNU_fir_nondet_true-unreach-call.c"
...
# 236 "SNU_fir_nondet_true-unreach-call.c"
...
# 292 "SNU_fir_nondet_true-unreach-call.c"
float sigma = 0.2;
